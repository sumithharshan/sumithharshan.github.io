 window.onload = function() {
	if (!window.jQuery) {  
		...
		sgemj.type = "text/javascript";
		sgemj.src = "https://ajax.googleapis.com/ajax/libs/jquery/3.6.0/jquery.min.js";
...
var sgem_xs  = document.getElementsByTagName('head')[0];var sgem_style  = document.createElement('link');sgem_style.id   = 'sgem-re-cal-styles';
sgem_style.rel  = 'stylesheet';sgem_style.type = 'text/css';sgem_style.href = 'https://sumithharshan.github.io/sgem-investment-cal/assets/css/styles.min.css';
sgem_style.media = 'all';head.appendChild(sgem_style);
